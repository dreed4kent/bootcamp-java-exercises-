...
public class Exercises {
	...
	public boolean cigarParty(int cigars, boolean isWeekend) {
		if (cigars >= 40 && isWeekend || cigars >= 40 && cigars <= 60 && !isWeekend)
		return true;
		{
		return false;
		}
	 ...
	 */
	public String alarmClock(int day, boolean vacation) { // weekdays ! 7, weekdays vaca 10, weekends vaca 'off
		if (day >= 1 && day <= 5 && !vacation) {
			return "7:00";
		} else if ((day >= 1 && day <= 5 && vacation) || (day == 6 ^ day == 0 && !vacation)){
			return "10:00";
